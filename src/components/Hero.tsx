...
export default function Hero({ variant = 'custom' }: HeroProps) {
  ...
  const heroShellClass = isHighLevel
    ? 'relative w-full min-h-[581px] overflow-clip rounded-[32px] bg-gradient-to-b from-[#fdf9f4] via-[#ccdfff] to-[#bdd9ff]'
    : 'relative w-full min-h-[581px] overflow-clip rounded-[32px] bg-gradient-to-b from-[#fdf9f4] to-[#f4e1f1] via-[#fef1e8]'
  ...
  return (
    <div
      ...
      data-name="Hero"
    >
      <div className="@container relative mx-auto flex h-auto min-h-[581px] w-full max-w-[1112px] flex-col @min-[1160px]:h-[581px] @min-[1160px]:max-w-[1280px] @min-[1160px]:flex-row @min-[1160px]:items-start @min-[1160px]:justify-between @min-[1160px]:gap-6 @min-[1160px]:pl-2 @min-[1160px]:pr-10 @min-[1160px]:pt-[80px]">
        <div className="relative z-30 h-[581px] w-full shrink-0 @min-[1160px]:w-[560px] @min-[1160px]:max-w-[560px]">
      <div
        className="absolute bg-white border border-[rgba(0,0,0,0.06)] border-solid content-stretch flex gap-[12px] items-center justify-center left-[47px] overflow-clip pl-[16px] pr-[20px] py-[10px] rounded-[999px] shadow-[0px_2px_6px_0px_rgba(0,0,0,0.05)] top-[80px] @min-[1160px]:top-0"
      ...
      {isHighLevel ? (
        <>
          <div
            className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[0] left-[47px] not-italic text-[#10172a] text-[48px] top-[168px] tracking-[-1.44px] w-[628px] max-w-[calc(100%-24px)] whitespace-pre-wrap @min-[1160px]:top-[88px]"
          ...
          <p
            className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[28px] left-[47px] not-italic text-[#596070] text-[18px] top-[296px] w-[463px] max-w-[calc(100%-24px)] @min-[1160px]:top-[216px]"
          ...
          <div
            className="absolute content-stretch flex flex-col gap-[16px] items-start left-[47px] overflow-clip top-[426px] @min-[1160px]:top-[346px]"
        ...
        <>
          <p
            className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[47px] not-italic text-[#10172a] text-[48px] top-[168px] tracking-[-1.44px] w-[550px] max-w-[calc(100%-24px)] @min-[1160px]:top-[88px]"
            data-node-id="229:11109"
          >
            Every great brand has an
          </p>
          <div
            className="-translate-y-1/2 absolute flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] left-[152px] not-italic text-[#10172a] text-[48px] top-[262px] tracking-[-1.44px] whitespace-nowrap @min-[1160px]:top-[182px]"
            data-node-id="331:12619"
          >
            <p className="leading-[normal]">Now yours does to</p>
          </div>
          <p
            className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[28px] left-[47px] not-italic text-[#596070] text-[18px] top-[302px] w-[551px] max-w-[calc(100%-24px)] @min-[1160px]:top-[222px]"
      ...
      {!isHighLevel ? (
        <div
          className="-translate-y-1/2 absolute flex flex-col font-['Plus_Jakarta_Sans',sans-serif] font-semibold italic justify-center leading-[0] left-[47px] text-[#155eef] text-[48px] top-[261px] tracking-[-1.44px] whitespace-nowrap @min-[1160px]:top-[181px]"
        ...
        <div className="relative z-0 mx-auto h-[540px] w-full max-w-[1112px] shrink-0 overflow-visible @min-[1160px]:static @min-[1160px]:z-10 @min-[1160px]:mx-0 @min-[1160px]:h-[581px] @min-[1160px]:w-[552px] @min-[1160px]:max-w-[552px]">
      {!isHighLevel ? (
        <>
          <div className="absolute flex h-[360.981px] items-center justify-center left-[814.48px] top-[130px] w-[212.138px] @min-[1160px]:left-[254px] @min-[1160px]:top-[50px]">
          ...
          <div
            className="absolute bg-[#171c2b] border-[#333340] border-[3.185px] border-solid h-[339.233px] left-[770px] overflow-clip rounded-[12.741px] shadow-[0px_9.556px_19.112px_-3.185px_rgba(0,0,0,0.35)] top-[136.59px] w-[156.477px] @min-[1160px]:left-[210px] @min-[1160px]:top-[56px]"
          ...
          <div className="absolute flex h-[364.411px] items-center justify-center left-[658px] top-[136.59px] w-[220.724px] @min-[1160px]:left-[98px] @min-[1160px]:top-[56px]">
        ...
        <>
          <div className="absolute flex h-[342.856px] items-center justify-center left-[825.45px] top-[125.93px] w-[201.487px] @min-[1160px]:left-[265px] @min-[1160px]:top-[46px]">
            <div className="flex-none rotate-[9.84deg]">
              <div
          ...
          <div
            className="absolute bg-[#171c2b] border-[#333340] border-[3.025px] border-solid h-[322.201px] left-[768.61px] overflow-clip rounded-[12.101px] shadow-[0px_9.076px_18.152px_-3.025px_rgba(0,0,0,0.35)] top-[131.25px] w-[148.621px] @min-[1160px]:left-[208px] @min-[1160px]:top-[51px]"
          ...
          <div className="absolute flex h-[334.675px] items-center justify-center left-[658.32px] top-[130.26px] w-[178.069px] @min-[1160px]:left-[98px] @min-[1160px]:top-[50px]">
      ...
      <div
        className={`absolute bg-white border border-[rgba(0,0,0,0.05)] border-solid content-stretch flex gap-[12px] items-center justify-center overflow-clip pl-[14px] pr-[18px] py-[12px] rounded-[16px] shadow-[0px_10px_24px_-4px_rgba(0,0,0,0.1)] ${
          isHighLevel
            ? 'left-[575px] top-[100px] @min-[1160px]:left-[15px] @min-[1160px]:top-[20px]'
            : 'left-[568px] top-[103px] @min-[1160px]:left-[8px] @min-[1160px]:top-[23px]'
        }`}
      ...
      <div
        className={`absolute bg-white border border-[rgba(0,0,0,0.05)] border-solid content-stretch flex gap-[12px] items-center justify-center overflow-clip pl-[14px] pr-[18px] py-[12px] rounded-[16px] shadow-[0px_10px_24px_-4px_rgba(0,0,0,0.1)] ${
          isHighLevel
            ? 'left-[586px] top-[369px] @min-[1160px]:left-[26px] @min-[1160px]:top-[289px]'
            : 'left-[606px] top-[416px] @min-[1160px]:left-[46px] @min-[1160px]:top-[336px]'
        }`}
      ...
      <div
        className={`absolute bg-white border border-[rgba(0,0,0,0.05)] border-solid content-stretch flex gap-[12px] items-center justify-center overflow-clip pl-[14px] pr-[18px] py-[12px] rounded-[16px] shadow-[0px_10px_24px_-4px_rgba(0,0,0,0.1)] ${
          isHighLevel
            ? 'left-[863px] top-[349px] @min-[1160px]:left-[303px] @min-[1160px]:top-[269px]'
            : 'left-[880px] top-[403px] @min-[1160px]:left-[320px] @min-[1160px]:top-[323px]'
        }`}
      ...
      <div
        className={`absolute bg-white border border-[rgba(0,0,0,0.05)] border-solid content-stretch flex gap-[12px] items-center justify-center overflow-clip pl-[14px] pr-[18px] py-[12px] rounded-[16px] shadow-[0px_10px_24px_-4px_rgba(0,0,0,0.1)] ${
          isHighLevel
            ? 'left-[875px] top-[94px] @min-[1160px]:left-[315px] @min-[1160px]:top-[14px]'
            : 'left-[874px] top-[100px] @min-[1160px]:left-[314px] @min-[1160px]:top-[20px]'
        }`}
